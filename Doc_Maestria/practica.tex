...
Para la calibración de camaras subacuaticas, es necesario modelar la refraccion en agua-vidrio-aire, la disrcion de la imagen por el lente, factores ambientales como temperatura, salinidad, color, iluminación. En general la mayoria de los metodos actuales se centran en la corrección geometrica por refracción como la calibración de zhang \parencite{calZhang}, a diferencia de la integración de efectos termicos y de color \parencite{11176009}.
